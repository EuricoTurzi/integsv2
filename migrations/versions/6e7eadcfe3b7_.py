...
Revision ID: 6e7eadcfe3b7
Revises: e3607654a7f8
Create Date: 2024-05-15 14:28:50.463570
...
revision = '6e7eadcfe3b7'
down_revision = 'e3607654a7f8'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('client', sa.VARCHAR(length=120), nullable=False),
    sa.Column('entrance_type', sa.VARCHAR(length=50), nullable=False),
    sa.Column('model', sa.VARCHAR(length=50), nullable=True),
    sa.Column('customization', sa.VARCHAR(length=100), nullable=True),
    sa.Column('type_of_receipt', sa.VARCHAR(length=50), nullable=False),
    sa.Column('recipients_name', sa.VARCHAR(length=50), nullable=True),
    sa.Column('withdrawn_by', sa.VARCHAR(length=50), nullable=True),
    sa.Column('equipment_numbers', sa.VARCHAR(length=200), nullable=False),
    ...
    sa.Column('customization', sa.VARCHAR(length=120), nullable=False),
