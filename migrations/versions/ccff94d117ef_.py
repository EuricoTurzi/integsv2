...
Revision ID: ccff94d117ef
Revises: 434218f4095b
Create Date: 2024-05-13 17:50:47.357895
...
revision = 'ccff94d117ef'
down_revision = '434218f4095b'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('maintenance_number', sa.VARCHAR(length=100), nullable=True),
    ...
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('client_name', sa.TEXT(length=120), nullable=False),
    sa.Column('reason', sa.TEXT(length=20), nullable=False),
    sa.Column('billing', sa.TEXT(length=20), nullable=False),
    sa.Column('model', sa.TEXT(length=120), nullable=False),
    sa.Column('customization', sa.TEXT(length=120), nullable=False),
    sa.Column('equipment_number', sa.TEXT(length=20), nullable=False),
    sa.Column('problem_type', sa.TEXT(length=50), nullable=False),
    sa.Column('photos', sa.TEXT(length=255), nullable=True),
    sa.Column('treatment', sa.TEXT(length=50), nullable=False),
    sa.Column('status', sa.TEXT(length=20), nullable=False),
    sa.Column('date_completed', sa.TEXT(length=20), nullable=True),
